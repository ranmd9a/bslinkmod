...
- そのうち beatsaver.com が修正されるか、誰かがもっと完璧なものを作ってくれる気がするので作りは少々適当です。
- 2021/08/06時点の beatsaver.com で動作確認したので、beatsaver.com の仕様変更により動かなくなる可能性があります。その場合は前述の下記手順でアンインストールしてください。
